...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet(){
        ...
        if(TextUtils.isEmpty(mName) && TextUtils.isEmpty(mBreed) &&
                TextUtils.isEmpty(weightText) && mGender == PetsContract.PetEntry.GENDER_UNKNOWN){
            return;
        }
        ...
        values.put(PetsContract.PetEntry.COLUMN_PET_NAME,mName);
        values.put(PetsContract.PetEntry.COLUMN_PET_BREED, mBreed);
        ...
        if(data == null){
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this, getString(R.string.editor_edit_pet_fail),
                        Toast.LENGTH_SHORT).show();
            } else {
